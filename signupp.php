<?php
    ...
    if (isset($_SESSION['SESSION_EMAIL'])) {
        header("Location: ../signup/welcome.php");
        die();
    }

    //Load Composer's autoloader
    // require '../signup/vendor/autoload.php';

    include '../live/signup/config.php';
    $msg = "";
    ...
    <div class="alert" style="
        ...
        <div class="sign-box">
            <div class="signin-form">
                ...
                <!-- <div class="btn">                
                    <button name="submit" class="bt" type="submit">Register</button>
                </div> -->
